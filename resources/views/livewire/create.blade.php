            ...
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="mb-4">
                            <label for="formPhone" class="block text-gray-700 text-sm font-bold mb-2">Alamat:</label>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-control" wire:model="status" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                <option value="">Keamanan Informasi</option>
                                <option value="1">Sitem Terdistribusi</option>
                                <option value="0">Teori Bahasa Otomata</option>
                                <option value="1">Praktikum Pweb</option>
                            </select>
